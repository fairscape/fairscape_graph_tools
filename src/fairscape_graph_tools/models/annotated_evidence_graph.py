"""AnnotatedEvidenceGraph model -- graph-level LLM interpretation of an RO-Crate.

Contains the per-computation annotations plus synthesized executive summary,
narrative, key findings, cross-cutting assumptions, and audience-specific
perspectives (biostatistician, clinician, etc.).
"""
