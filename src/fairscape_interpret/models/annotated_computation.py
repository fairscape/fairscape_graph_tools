"""AnnotatedComputation model -- Pydantic schema for a per-computation LLM annotation.

Uses fairscape_models base classes (IdentifierValue, DigitalObject) for the
schema.org / PROV-O scaffolding; this file defines only the interpretation-specific
fields (assumptions, errors, code/dataset summaries, computation status).
"""
